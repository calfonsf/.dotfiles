...
awful.rules.rules = {
    ...
    -- Disable borders for third party bars
    { rule_any = { 
	    class = { "Eww", "eww", "polybar" }} , 
    ...
    { rule = {floating=true}
      }, properties = { placement = awful.placement.centered+awful.placement.no_offscreen
    },
...
client.connect_signal("manage", function (c)
    ...
    -- fix the spawning terminal to the right side
    if not awesome.startup then awful.client.setslave(c) end
end)

-- Disable window maximization and minimization
...
-- Enable that focus follows mouse.
